...
function showProducts() {
    cartitems.forEach(function (product) {
        ...
        function decressQuantirty() {
            ...
            if (quantity.innerText <= 1) {
                ...
                minus.removeEventListener("click", decressQuantirty);
                plus.addEventListener("click", increassQuantirty);
    ...
    //    console.log(individual_total_amount.innerText , "im")
       ...
       line.setAttribute("style","margin-top:15px;height: 1px;background-color: #E0E0E0; border:none")
    ...
    function removetoCart(e,prod) {
      ...
      amount.setAttribute("style","margin-left:-52%;font-weight:600;font-size:20px")
